...
export const menu=[
    ...
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Get started with driving" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Rules of the road" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Important car parts" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Steering wheel usage" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Automatic and manual cars" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Speed on the road" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Car lights and when to use them" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Road offenses and punishment" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Important road signs/categories" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'INTRODUCTION_TO_DRIVING', type: 'ionic', icon: "", name: "Other important aspect on the road" },

    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Introduction to simple mechanics" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Simple mechanics emergency tools" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "How to fix a car tire" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Jumpstart your car" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Change oil" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Replace brake pads" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Replace air filter" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Replace headlights or tailights" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Change wiper blades" },
    { id: 12, component:"ItemList", param:"GET_STARTED_WITH_DRIVING", navigateTo:"", indicator:'BASIC_MECHANICS', type: 'ionic', icon: "", name: "Change the battery" },
